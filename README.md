...
### Аргументы:
  ...
  - `--lang` — указать язык исходного видео (см. [вики](https://github.com/FOSWLY/vot-cli#NOT-IMPLEMENTED)  чтобы узнать какие языки поддерживаются)
  - `--reslang` — Указать язык полученноого аудио файла (см. [вики](https://github.com/FOSWLY/vot-cli#NOT-IMPLEMENTED) чтобы узнать какие языки поддерживаются)
